...
// My Additions
// Route::screen('/listings', ListingsScreen::class)->name('platform.listings');

// Route::screen('listings', ListingsScreen::class)
...
// Listing Edit Screen
Route::screen('listing/{listing?}', ListingEditScreen::class)
    ->name('platform.listing.edit');
